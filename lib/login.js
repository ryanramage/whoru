...
module.exports = function login (db, fingerprint, userloginID, loginType, app, space, details, cb) {
  ...
  //   // we can collect the fingerprint later, let them login
  //   return fingerprintlessLogin(db, userloginID, loginType, app, space, details, cb)
  // }
...
function fingerprintlessLogin (db, userloginID, loginType, app, space, details, cb) {

  // see if we have this person at all
