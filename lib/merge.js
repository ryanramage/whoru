...
exports.person = function (db, from_person_id, to_person_id, cb) {
  async.parallel({
    ...
    var accounts = {}
    data.from.accounts.forEach(function (_account) {
    ...
    async.map(Object.keys(accounts), function (_account, done) {
      ...
      var login_cache = {}
      data.to.accounts.forEach(function (_account) {
      ...
      data.from.accounts.forEach(function (_account) {
        ...
        __account.logins.forEach(function (_login) {
          delete _login._ids
      ...
      flatten(_accounts).forEach(function (_indexuserlogin) {
        ...
        accounts_to_replace.forEach(function (_atr) {
          _indexuserlogin._id = _indexuserlogin._id.replace(_atr.from, _atr.to)
        })
        inserts.push(_indexuserlogin)
      })

      flatten(data.related.indexpersonfingerprints).forEach(function (_indexpersonfingerprints) {
      ...
      flatten(data.related.loginfingerprints).forEach(function (_loginfingerprints) {
...
exports.findRelated = function (db, from_person_id, cb) {
  ...
  allDetails(db, key, function (err, resp) {
    ...
    var from_person_fingerprints = results.indexpersonfingerprints.map(function (index_person_to_fingerprint_doc) {
